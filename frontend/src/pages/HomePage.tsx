...
export default function HomePage() {
  ...
  const { backgroundUrl, current, total, ready, shuffleBackground } =
    useRandomBackground();
  ...
  const quoteTextClassName = ["quote-text", quoteSizeClass]
    .filter(Boolean)
    .join(" ");
  ...
  return (
    <section className="landing-page">
      ...
      <div className="landing-content">
        ...
        <ParticleTextEffect words={["I'm 小镇子", "Build AI, Ship Value."]} />
        ...
        <p className="shortcut-guide">
          快捷键：1 Blog · 2 AI工具 · 3 软件资源 · 4 影视网 · B 换背景
        </p>
      </div>
